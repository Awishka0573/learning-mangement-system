...
<header>
    <div class="navbar">
        <div class="logo"><img src="assets\LMS_logo.jpg" alt="Logo"></div>
        <ul class="nav-links">
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="subject-buttons">
                <button class="subject red">WEB</button>
                <button class="subject black">OOP</button>
                <button class="subject red">DBMS</button>
                <button class="subject black">IS</button>
                <button class="subject red">DSA</button>
                <button class="subject black">OS</button>
                <button class="subject red">Statics</button>
            </div>
        </div>
    </div>
